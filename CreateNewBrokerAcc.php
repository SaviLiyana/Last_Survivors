...
<!--        <h3 align="center" style="color: #ECF0F1">Designed by team 'Last Survivors'</h3>-->
        ...
        <h2  style="margin-top:50px; margin-bottom:50px; margin-left:292px;">Create New Broker Account</h2>
        ...
        <div class="container" >
            ...
            <form class="form-horizontal" action="/action_page.php">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="bankveri" style="margin-left:120px;">bank verification code :</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="bankveri" placeholder="Enter bank verification code" name="bankveri">
                    </div>
                </div><hr/>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-default btn-info" style="margin-left:120px;">Create Account</button>
                    </div>
                </div><br/>
